...
acs_dp02_11 = subset(acs_dp02_11, select = c(sel20a,sel21a, sel22a))
acs_dp02_12 = subset(acs_dp02_12, select = c(sel20a,sel21a, sel22a))
...
acs_dp02_13 = subset(acs_dp02_13, select = c(sel20,sel21, sel22))
acs_dp02_14 = subset(acs_dp02_14, select = c(sel20,sel21, sel22))
tmp2 = rbind(acs_dp02_13, acs_dp02_14)
names(tmp2)[5:ncol(tmp2)] = names(tmp1)[5:ncol(tmp1)]

acs_dp02 = rbind(tmp1, tmp2)
rm(acs_dp02_11, acs_dp02_12, acs_dp02_13, acs_dp02_14,sel20,sel21,sel22, sel20a,sel21a,sel22a, tmp1, tmp2)
...
sel31a = paste0('HC01_VC', formatC(c(4:10,13,75:85,121, 166), width = 2, flag=0))
sel32a = paste0('HC03_VC', formatC(c(4:10,13,75:85,121, 166), width = 2, flag=0))
...
sel31 = paste0('HC01_VC', formatC(c(3:9,12,75:85,124, 171), width = 2, flag=0))
sel32 = paste0('HC03_VC', formatC(c(3:9,12,75:85,124, 171), width = 2, flag=0))
...
acs_dp04_11 = subset(acs_dp04_11, select = c(sel40a,sel41a, sel42a))
acs_dp04_12 = subset(acs_dp04_12, select = c(sel40a,sel41a, sel42a))
...
acs_dp04_13 = subset(acs_dp04_13, select = c(sel40,sel41, sel42))
acs_dp04_14 = subset(acs_dp04_14, select = c(sel40,sel41, sel42))
tmp2 = rbind(acs_dp04_13, acs_dp04_14)
names(tmp2)[5:ncol(tmp2)] = names(tmp1)[5:ncol(tmp1)]

acs_dp04 = rbind(tmp1, tmp2)
write.csv(acs_dp04, './data/ACS/acs_dp04.csv')
rm(acs_dp04_11, acs_dp04_12, acs_dp04_13, acs_dp04_14,sel40,sel41,sel42, sel40a,sel41a,sel42a, tmp1, tmp2)
...
acs_dp05_11 = subset(acs_dp05_11, select = c(sel50a,sel51a, sel52a))
acs_dp05_12 = subset(acs_dp05_12, select = c(sel50a,sel51a, sel52a))
...
acs_dp05_13 = subset(acs_dp05_13, select = c(sel50,sel51, sel52))
acs_dp05_14 = subset(acs_dp05_14, select = c(sel50,sel51, sel52))
tmp2 = rbind(acs_dp05_13, acs_dp05_14)
names(tmp2)[5:ncol(tmp2)] = names(tmp1)[5:ncol(tmp1)]

acs_dp05 = rbind(tmp1, tmp2)
write.csv(acs_dp05, './data/ACS/acs_dp05.csv')
rm(acs_dp05_11, acs_dp05_12, acs_dp05_13, acs_dp05_14,sel50,sel51,sel52, sel50a,sel51a,sel52a, tmp1, tmp2)


#CENSUS DATASET
names(acs_dp02) = rename_acs(names(acs_dp02), 'DP02')
names(acs_dp03) = rename_acs(names(acs_dp03), 'DP03')
names(acs_dp04) = rename_acs(names(acs_dp04), 'DP04')
names(acs_dp05) = rename_acs(names(acs_dp05), 'DP05')
