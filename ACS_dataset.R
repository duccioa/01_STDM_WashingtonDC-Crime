...
sel21a = paste0('HC01_VC', formatC(c(4,6:12,75,85:91), width = 2, flag=0))
...
sel21 = paste0('HC01_VC', formatC(c(4:11, 76,86:92), width = 2, flag=0))
...
sel31a = paste0('HC01_VC', formatC(c(75:84), width = 2, flag=0))
...
sel31 = paste0('HC01_VC', formatC(c(75:84), width = 2, flag=0))
...
sel41a = paste0('HC01_VC', formatC(c(5,64, 117:124, 192:197), width = 2, flag=0))
...
sel41 = paste0('HC01_VC', formatC(c(5,65, 119:126, 197:202), width = 2, flag=0))
...
sel51a = paste0('HC01_VC', formatC(c(7:19), width = 2, flag=0))
...
sel51 = paste0('HC01_VC', formatC(c(8:20), width = 2, flag=0))
